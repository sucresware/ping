...
function updateTheme()  {
    ...
    document.querySelectorAll('.dark-hidden').forEach(el => el.style.display = dark ? "none" : "block")
    document.querySelectorAll('.dark-visible').forEach(el => el.style.display = dark ? "block" : "none")
}
